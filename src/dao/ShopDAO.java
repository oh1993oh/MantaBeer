...
public class ShopDAO {
	...
	public ArrayList<ShopBean> selectProductList(int page, int limit, String category, String origin) {
		...
		try {
			...
			System.out.println("selectProductList sql구문요청 에러 :" + e.getMessage());
		} finally {
			close(rs);
			close(pstmt);
		}
	...
	public ShopBean selectProduct(int product_num) {
		...
		try {
			...
			System.out.println("selectProduct sql구문요청 에러 :" + e.getMessage());
		} finally {
			close(rs);
			close(pstmt);
		}
	...
	public int insertTrade_onCart(TradeBean tradeBean) {
		...
		try {
			...
			System.out.println("insertTrade_onCart 에러 :" + e.getMessage());
		} finally {
			close(pstmt);
		}
	...
	public int adress_Modify(AdressBean adressBean) {
		...
		try {
			...
			System.out.println("adress_Modify 에러 :" + e.getMessage());
		} finally {
			close(pstmt);
		}
