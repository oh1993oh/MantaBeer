...
<body class="goto-here">
   ...
   <div class="col-lg-3 sidebar ftco-animate float" style="margin-right: 200px;">
      ...
      <div class="sidebar-box ftco-animate">
         ...
         <form>
            <ul>
               <li><a href=" http://sapporo-natsu.com/english/" style="color: black;">삿포로 오도리
                     비어가든</a></li>
               <li><a
                  href=" http://www.thatsqingdao.com/qingdao-international-beer-festival/" style="color: black;">
                     청도 맥주 축제</a></li>
               <li><a href=" http://www.oktoberfest.de" style="color: black;"> 옥토버 페스트</a></li>
               <li><a href=" http://www.pilsnerfest.cz/" style="color: black;"> 체코 필스너 페스트</a></li>
               <li><a href="http://www.hrbicesnow.com/beer" style="color: black;"> 하얼빈 국제 맥주 축제</a></li>
            </ul>
         </form>
      </div>
   </div>
                  ...
                  <div class="row" id="picture">
                     <div class="text d-block pl-md-4">
                        <div class="meta mb-3">
                           ...
                           <span><%=articleList.get(i).getBlog_date()%></span> <span>
                              <a href="" style="color: black;">Admin</a>
                           </span> <span> <a href="" class="meta-chat" style="color: black;"><span
                                 class="icon-chat"><%=articleList.get(i).getReadcount()%></span></a>
                           </span>
                        </div>
                                    <h3 class="heading">
                        <%=articleList.get(i).getBlog_subject()%>
                                    </h3>      
                        <img src="./blogUpload/<%=articleList.get(i).getBlog_file()%>"
...
<%--                       <%=articleList.get(i).getBlog_content()%> --%>
                        ...
                        <p>
                           <a
                              href="BlogDetail.bl?blog_num=<%=articleList.get(i).getBlog_num()%>&page=<%=nowPage%>"
