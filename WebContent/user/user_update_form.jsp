      ...
      <div class="top_main">
		...
		<form action="UserupdatePro.me" method="post" style="width: 450px;">
			...
			<label class="name_w"> 성명 </label>
			 <input type="text" name="user_name" value=<%=user.getUser_name()%>><br> 
			</div>
			<div class="mypage">
			 <label class="name_w">이메일 주소 </label> 
			 <input type="email" name="user_email" value=<%=user.getUser_email()%>><br>
			</div>
			<div class="mypage">
			 <label class="name_w">휴대 전화 번호 </label> 
			  <input type="text" name="user_number"value=<%=user.getUser_number()%>><br> 
			</div>
			<div class="btn_content">
			  <input type="reset" value="재입력하기" class="update_bottom"> 
			  <input  type="submit" value="정보수정하기" class="update_bottom">
