...
ArrayList<TradeBean> list= (ArrayList)request.getAttribute("getdepositservice");
String state = "";
%>
...
<body class="goto-here">
	...
	<section class="container" >
		...
		<div class="table_list">
			<div class="ul_list" style="clear: both; position: relative;left: 19px;border: 1px solid gray;height: 30px; width: 723px;">
				<ul style="list-style: none;">
					...
					<li style="float: left;width: 96px;text-align: center;border-right: 1px solid gray;">거래상태</li>
					<li style="float: left;width: 85px;padding: 0px 0px;text-align: center;">입금확인</li>
				</ul>
			</div>
			<%
			...
			<div  style="clear: both;">
				<div class="admin_tr" style="clear: both;">
					...
					<div class="td_admin" style="text-align: center; position: relative;float: left;left: 20px;top: 10px;border-top: 1px solid gray;border-right: 1px solid gray;border-bottom: 1px solid gray;width: 107px;">
						<a href="user_detaillist.me?trade_classification=<%=tb.getTrade_classification()%>&user_id=<%=tb.getUser_name()%>" style="color: green;" > <%=tb.getTrade_classification()%></a>
					</div>
					...
					<div class="td_admin" style="position: relative;float: left;left: 20px;top: 10px;border-top: 1px solid gray;border-right: 1px solid gray;border-bottom: 1px solid gray;width: 96px;">
						<%
							...
							%>	
								<span><input type="button" value="제품수령하기" onclick="getProduct(<%=tb.getTrade_classification() %>)" style="position: relative;height: 28px;outline: 0;border: 0;border-right: 3px solid white;background: black;color: white;width: 99px;"></span>
							<%
							}else{
							%>		
								<span><input type="button" value="<%=state %>" style="position: relative;height: 28px;outline: 0;border: 0;border-right: 3px solid white;background: black;color: white;width: 99px;"></span>
							<%
							}
						%>
	...
	<section style="height: 100px; float: left;">
	</section>
	...
	<script type="text/javascript">
		function getProduct(num){
			location.href='stateChange.me?classification='+num+'&state=deal_completed';
		}
